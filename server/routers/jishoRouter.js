...
router.get('/', asyncErrorHandle_1.default(function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                ;
                return [4 /*yield*/, rp.get("https://jisho.org/api/v1/search/words?keyword=" + encodeURIComponent(req.query.keyword))];
            case 1:
                resultStr = _a.sent();
